...
export function RevenueGrowthInsight({ onBack, onChatStart }: RevenueGrowthInsightProps) {
  ...
  return (
    <div className="flex h-full w-full overflow-hidden bg-[#f3f6f7] relative">
      {/* Top Header */}
      <div className="absolute top-0 left-0 right-0 z-10 flex items-center gap-3 border-b border-[#E6EBEC] px-6 py-4 bg-white">
      ...
      <div className="flex-1 overflow-y-auto pt-[73px]">
        <div className="mx-auto max-w-3xl p-8 space-y-6">
          {/* Insight Overview Section (Chart) */}
          <div className="bg-white rounded-xl border border-[#E6EBEC] shadow-[0px_0px_6px_rgba(0,0,0,0.02),0px_2px_4px_rgba(0,0,0,0.08)] p-8">
              ...
              <div className="h-64 relative w-full">
                ...
                <div className="ml-10 h-full relative">
                  ...
                  <svg className="absolute inset-0 w-full h-full" viewBox="0 0 600 250" preserveAspectRatio="none">
                    ...
                    {/* Fill Area */}
                    <path 
                      d="M 0 212 L 180 212 L 220 170 L 300 170 L 340 127 L 440 127 L 500 85 L 600 42 L 600 127 L 500 127 L 440 170 L 340 170 L 300 212 L 0 212 Z"
                      fill="url(#chartGradient)"
                    />
                    
                    {/* Blue line (Forecast) */}
                    <path
                      d="M 0 212 L 280 212 L 320 170 L 420 170 L 460 127 L 600 127"
                      fill="none"
                      stroke="#1e40af" 
                      strokeWidth="2"
                      strokeDasharray="4 4"
                    ...
                    {/* Teal line (Improvement) */}
                    <path
                      d="M 180 212 L 220 170 L 300 170 L 340 127 L 440 127 L 500 85 L 600 42"
                      fill="none"
                      stroke="#14b8a6"
                      strokeWidth="2"
                      strokeDasharray="3 3"
          ...
          {/* Insight Details */}
          <div className="bg-white rounded-xl border border-[#E6EBEC] shadow-[0px_0px_6px_rgba(0,0,0,0.02),0px_2px_4px_rgba(0,0,0,0.08)] p-8 space-y-8">
            {/* INSIGHT Section */}
      ...
      <ChiefChatPopup 
        ...
        contextTitle="this revenue insight"
      />
    </div>
  );
}
